...
export const Footer = () => {
  return (
    <div className="footetbg">
      <div>
        <footer class="text-gray-600 body-font">
          <div class="border-t border-gray-200">
            <div class="container px-5 py-1 flex flex-wrap mx-auto items-center">
              <div class="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
                ...
                <button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 m-2 focus:outline-none hover:bg-indigo-600 rounded">
                  SUBSCRIBE
                </button>
